package me.gravityio.goodlib.betterloot;
...
public class BetterLootRegistry {
    ...
    public static void registerLoot(Identifier structureKey, Identifier lootTableKey) {
        BetterLootMod.LOGGER.debug("[BetterLootRegistry] Registering Loot {} for Structure: {}", lootTableKey, structureKey);
    ...
    public static List<Identifier> getLoot(Identifier structureKey) {
        BetterLootMod.LOGGER.debug("[BetterLootRegistry] Getting Loot for Structure: {}", structureKey);
